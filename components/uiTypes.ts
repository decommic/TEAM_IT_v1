...
export const getInitialStateForApp = (viewId: string): AnyAppState => {
    switch (viewId) {
        ...
        case 'pattern-designer':
            return { stage: 'idle', clothingImage: null, patternImage: null, patternImage2: null, generatedImage: null, historicalImages: [], options: { useBasicOptions: true, useAdvancedOptions: false, applyMode: '', aspectRatio: 'Giữ nguyên', patternScale: 1, notes: '', changeObjectColor: false, objectColorToChange: '#ffffff', removeWatermark: false, productType: '', tshirtColorBody: '', tshirtColorLeftSleeve: '', tshirtColorRightSleeve: '', tshirtColorCollar: '', tshirtColorHem: '', tshirtPrintStyle: 'Tự động', tshirtPrintPosition: '', tshirtFit: '', tshirtCollarStyle: '', tshirtSleeveStyle: '', tshirtLength: '', tshirtFabric: '' }, error: null };
